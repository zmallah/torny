"""
Django settings for torny_backend project.
...
SECRET_KEY = 'c6zqj%mj&i2tu0go*%ny#41sm58%@i%0j2y4u+&5-u9crd1b%e'
...
WSGI_APPLICATION = 'torny_backend.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = ['torny_frontend/']
