...
event1 = Event(id=1, event_type='touch_scored')
event2 = Event(id=2, event_type='yellow_card')
event3 = Event(id=3, event_type='red_card')
event4 = Event(id=4, event_type='black_card')
event5 = Event(id=5, event_type='bout_over')
